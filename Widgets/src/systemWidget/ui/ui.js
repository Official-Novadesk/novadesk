...
ipc.on("cpu-usage", function (data) {
    win.setElementProperties("cpu_Text", { "text": data + "%" });
    win.setElementProperties("cpu-Bar", { "value": data / 100 });
})

ipc.on("memory-usage", function (data) {
    win.setElementProperties("memory_Text", { "text": data + "%" });
    win.setElementProperties("memory-Bar", { "value": data / 100 });
})
